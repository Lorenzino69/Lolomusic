...
export class SearchViewComponent implements AfterViewInit {
  ...
  public tracksSpotify: TracksSpotifyCollection<TrackSpotifyModel>;
  ...
  constructor(private humanReadableSecondsPipe: HumanReadableSecondsPipe,
    ...
    this.tracksSpotify = new TracksSpotifyCollection();
  ...
  public selectTab(tabPane: TabPaneComponent) {
    switch (tabPane.id) {
      ...
      case ProviderMap.deezer.id:
        ...
        break;
      case ProviderMap.spotify.id:
        this.searchCollection = this.tracksSpotify;
        break;
    }
