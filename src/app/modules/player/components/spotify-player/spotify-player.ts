...
@Component({
  ...
  styleUrls: ['./spotify-player.scss'],
  templateUrl: './spotify-player.html'
})
export class SpotifyPlayerComponent extends AbstractPlayer implements IPlayer, OnInit, OnDestroy {
  ...
  @Input()
  public track: TrackSpotifyModel;
  ...
  protected preloadTrack(track: TrackSpotifyModel, startTime: number = 0) {
